...
export function mapDatabaseListingToAppListing(row = {}) {
  ...
  return {
    ...
    displayLocation: row.display_location || row.location,
    addressVerified: Boolean(row.address_verified),
    addressPlaceId: row.address_place_id || "",
    addressAccuracy: row.address_accuracy || "",
    ...
    postBookingActionRequired: Boolean(row.post_booking_action_required),
    status: row.status,
...
export function mapAppListingToDatabaseListing(listing = {}, options = {}) {
  ...
  return omitUndefinedFields({
    ...
    title: listing.title,
    location: listing.location || listing.displayLocation,
    ...
    display_location: listing.displayLocation || listing.location,
    address_verified: listing.addressVerified,
    address_place_id: listing.addressPlaceId,
    address_accuracy: listing.addressAccuracy,
    ...
    post_booking_action_required: listing.postBookingActionRequired,
